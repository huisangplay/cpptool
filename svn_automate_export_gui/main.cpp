    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        //  Show a simple window that we create ourselves. We use a Begin/End pair to create a named window.
        {
            ...
            if (endflag) {
                ...
                ImGui::InputTextMultiline(u8"导出文件列表", showchararray, IM_ARRAYSIZE(showchararray));
                ImGui::SameLine();
...
//                        cmdstr="svn log http://vcs.comac.intra/svn/sadri/项目代码 -r"+to_string(svn_num)+" --incremental";
