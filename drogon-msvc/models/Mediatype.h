...
class Mediatype
{
  public:
     ...
     */
    explicit Mediatype(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit Mediatype(const Json::Value &pJson) noexcept(false);
     ...
     */
    Mediatype(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<Mediatype>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<Mediatype>;
#endif
  ...
  public:
    ...
    {
        static const std::string sql="select * from " + tableName + " where MediaTypeId = ?";
        return sql;
    }

    static const std::string &sqlForDeletingByPrimaryKey()
    {
        static const std::string sql="delete from " + tableName + " where MediaTypeId = ?";
        return sql;
    }
