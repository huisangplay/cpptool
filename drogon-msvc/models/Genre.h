...
class Genre
{
  public:
     ...
     */
    explicit Genre(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit Genre(const Json::Value &pJson) noexcept(false);
     ...
     */
    Genre(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<Genre>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<Genre>;
#endif
  ...
  public:
    ...
    {
        static const std::string sql="select * from " + tableName + " where GenreId = ?";
        return sql;
    }

    static const std::string &sqlForDeletingByPrimaryKey()
    {
        static const std::string sql="delete from " + tableName + " where GenreId = ?";
        return sql;
    }
