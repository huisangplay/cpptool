...
class Customer
{
  public:
    struct Cols
    {
        ...
        static const std::string _SupportRepId;
    };
    ...
    void setCompanyToNull() noexcept;
    ...
    /**  For column SupportRepId  */
    ///Get the value of the column SupportRepId, returns the default value if the column is null
    const uint64_t &getValueOfSupportrepid() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<uint64_t> &getSupportrepid() const noexcept;
    ///Set the value of the column SupportRepId
    void setSupportrepid(const uint64_t &pSupportrepid) noexcept;
    void setSupportrepidToNull() noexcept;
  ...
  private:
    ...
    std::shared_ptr<uint64_t> supportrepid_;
    struct MetaData
    {
  ...
  public:
    ...
    {
        static const std::string sql="select * from " + tableName + " where CustomerId = ?";
        return sql;
    }

    static const std::string &sqlForDeletingByPrimaryKey()
    {
        static const std::string sql="delete from " + tableName + " where CustomerId = ?";
        return sql;
    }
